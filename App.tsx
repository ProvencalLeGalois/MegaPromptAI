            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar">
              {messages.length === 0 && (
                <div className="h-full flex flex-col items-center justify-center text-slate-500 opacity-60">
                  ...
                  <p className="text-lg font-medium">Assistant Gaming Anti‑Hallucination</p>
                  <p className="text-sm mt-2">Posez une question jeu vidéo claire (jeu + objectif) pour une réponse courte et fiable.</p>
                </div>
              )}
              {messages.map((m, idx) => (
